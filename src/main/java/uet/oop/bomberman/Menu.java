...
public class Menu {
    ...
    public static GridPane createMenu(Stage primaryStage) throws FileNotFoundException {
        ...
        menu.setOnMouseEntered(e->{
            menu.setImage(new Image("E:/Github/Bomberman/src/main/resources/textures/play1.png"));
        });
        menu.setOnMouseExited(e->{
            menu.setImage(new Image("E:/Github/Bomberman/src/main/resources/textures/play.png"));
        });
        ...
        help.setOnMouseEntered(e->{
            help.setImage(new Image("E:/Github/Bomberman/src/main/resources/textures/instruction1.png"));
        });
        ...
        exit.setOnMouseEntered(e->{
            exit.setImage(new Image("textures/exit1.png"));
        });
        exit.setOnMouseExited(e->{
            exit.setImage(new Image("textures/exit.png"));
        });

        newGame=new Image("images/volumeOn.png");
        ...
        black= new ImageView("images/blackBackground.png");
