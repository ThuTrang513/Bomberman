...
import static com.example.test.BombermanGame.*;
import static com.example.test.BombermanGame.WIDTH;
...
public class Menu  {
    ...
    public static GridPane createMenu(Stage primaryStage) throws FileNotFoundException {
        ...
        ImageView backGround = new ImageView(new Image(new FileInputStream("E:/test/src/main/resources/textures/main.png")));

        grid.getChildren().addAll(backGround);

        Image newGame = new Image("E:/test/src/main/resources/textures/play.png");
        ...
        newGame = new Image("E:/test/src/main/resources/textures/instruction.png");
        ...
        newGame = new Image("E:/test/src/main/resources/textures/exit.png");
        ...
        help.setOnMouseClicked(e->{
            ...
            ImageView instruction =new ImageView(new Image("E:/test/src/main/resources/textures/help.png"));
            grid.add(instruction,0,0);
            ImageView back=new ImageView(new Image("E:/test/src/main/resources/textures/back.png"));
