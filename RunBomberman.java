...
public class RunBomberman extends Application {
    ...
    public static ArrayList<Animal> enemy= new ArrayList<>();
    ...
    public void start(Stage stage){
        ...
        stage.setTitle("Bomberman by 404 NOT FOUND XXXXX");
        ...
        player = new Bomber(2, 1, Sprite.control_right_2.getFxImage());
    ...
    public void render() {
        gc.clearRect(10, 0, canvas.getWidth(), canvas.getHeight());
